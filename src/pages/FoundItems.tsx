...
const FoundItems = () => {
  ...
  const [items, setItems] = useState(demoItems.filter(item => item.type === "found"));
  const [filteredItems, setFilteredItems] = useState(items);
  const [showFilters, setShowFilters] = useState(false);

  useEffect(() => {
    // Get latest items on component mount
    const foundItems = demoItems.filter(item => item.type === "found");
    setItems(foundItems);
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Browse items found by KLH University members</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {filteredItems.length > 0 ? (
              ...
              <Card key={item.id} className="item-card">
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="px-2 py-1 rounded-full text-xs font-medium bg-found-light text-found">
                      Found
                    </span>
                  </div>
                  <CardDescription>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              If you found something, please report it using the "Report Item" page.
            </p>
            <Button 
              variant="default" 
